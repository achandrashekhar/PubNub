...
public class RegistrationServlet extends BaseServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//The REGEX for the password requirement a Capital letter, small case letter, followed my number and a special character!
		  ...
		  if(!matcher.find())
		  {
			  ...
			  String url = "/registrationError?error=password requirements not matched";
